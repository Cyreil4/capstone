...
class users{
	...
	{
		$query=$this->conn->query("select email,password from users where  email='$email' and password='$password'");
	...
	{
		$query=$this->conn->query("select * from admin where username='$username'");
